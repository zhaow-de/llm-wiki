...
Umbrella truth-seeking audit for llm-wiki. If `/pkb:librarian` keeps the
`wiki/` layer in check, `/pkb:audit` answers a broader question: can the user
...
| Command | Role |
|--------|------|
| `doctor` | Structural correctness and schema hygiene |
