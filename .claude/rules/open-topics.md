...
Each bullet is a markdown link to the topic file followed by a one-sentence description, e.g. `- [00000 — broken-link false positives](00000-broken-link-false-positives.md) — lint flags anchor-only links; revisit when the link checker learns about in-page anchors.`
